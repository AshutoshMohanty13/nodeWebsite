...
// User.hasMany(Product);
// User.hasOne(Cart);
// Cart.belongsTo(User); // optional and its inverse of the User.hasOne(Cart);
// Cart.belongsToMany(Product, { through : CartItem});// through tell the model wher these connections should be stored
